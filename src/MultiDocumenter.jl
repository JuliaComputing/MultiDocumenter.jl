...
"""
    SearchConfig(index_versions = ["stable"], engine = FlexSearch)
...
function make(
    ...
    inject_styles_and_global_navigation(dir, docs, brand_image, custom_stylesheets, custom_scripts, search_engine)
...
function make_global_nav(dir, docs, thispagepath, brand_image, search_engine)
    ...
    navitems = Gumbo.HTMLElement{:div}([], nav, Dict(
        "id" => "nav-items",
    ...
    for doc in docs
        ...
        a = Gumbo.HTMLElement{:a}([], navitems, Dict(
    ...
    toggler = Gumbo.HTMLElement{:a}([], nav, Dict(
        "id" => "multidoc-toggler"
    ))
                    ...
                    elseif Gumbo.tag(el) == :body && !isempty(el.children)
                        ...
                        if documenter_div isa Gumbo.HTMLElement &&
                           Gumbo.getattr(documenter_div, "id", "") == "documenter"
                            ...
                            global_nav = make_global_nav(dir, docs, root, brand_image, search_engine)
